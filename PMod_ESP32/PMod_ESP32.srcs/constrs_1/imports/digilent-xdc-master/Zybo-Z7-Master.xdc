...
set_property -dict { PACKAGE_PIN W8    IOSTANDARD LVCMOS33     } [get_ports { tx }]; #IO_L15N_T2_DQS_13 Sch=jb_n[1]         
set_property -dict { PACKAGE_PIN U7    IOSTANDARD LVCMOS33     } [get_ports { rx }]; #IO_L11P_T1_SRCC_13 Sch=jb_p[2]        
...
##Pmod Header JC                                                                                                                  
#set_property -dict { PACKAGE_PIN V15   IOSTANDARD LVCMOS33     } [get_ports { pwm_out }]; #IO_L10P_T1_34 Sch=jc_p[1]   			 
...
##Pmod Header JD                                                                                                                  
set_property -dict { PACKAGE_PIN T14   IOSTANDARD LVCMOS33     } [get_ports { pwm_out }]; #IO_L5P_T0_34 Sch=jd_p[1]                  
