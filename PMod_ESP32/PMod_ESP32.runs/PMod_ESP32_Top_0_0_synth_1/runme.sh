...
HD_PWD='C:/Vitis_SSC/Proiect_ESP32/PMod_ESP32/PMod_ESP32.runs/PMod_ESP32_Top_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PMod_ESP32_Top_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PMod_ESP32_Top_0_0.tcl
