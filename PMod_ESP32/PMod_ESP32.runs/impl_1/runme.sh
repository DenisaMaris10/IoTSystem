...
HD_PWD='C:/Vitis_SSC/Proiect_ESP32/PMod_ESP32/PMod_ESP32.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PMod_ESP32_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PMod_ESP32_wrapper.tcl -notrace
